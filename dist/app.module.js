    ...
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forRoot({
                ...
                password: "unicesumar",
                database: "blog",
                entities: [category_entity_1.Category, users_entity_1.User, tarefa_entity_1.Tarefa, cartao_entity_1.Cartao, tarefa_entity_1.HistoricoAlteracao],
                synchronize: true
            }),
            typeorm_1.TypeOrmModule.forFeature([cartao_entity_1.Cartao, tarefa_entity_1.Tarefa, tarefa_entity_1.HistoricoAlteracao]),
