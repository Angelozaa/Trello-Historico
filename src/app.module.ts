...
import { HistoricoAlteracao, Tarefa } from './tarefa/tarefa.entity';
...
@Module({
  imports: [
    TypeOrmModule.forRoot({
      ...
      password: "unicesumar",
      database: "blog",
      entities: [Category, User, Tarefa, Cartao, HistoricoAlteracao],
      synchronize: true
    }),
    TypeOrmModule.forFeature([Cartao, Tarefa, HistoricoAlteracao]),
    CategoriesModule,
    UsersModule,
    TarefaModule,
    CartaoModule
